    ...
    <div className={`${style.wrapper}`}>
      ...
      <div className={`${style.input_container}`}>
        ...
        <input
          ...
          ref={emailRef}
          />
        <i className={`${style.icon} ${style.icon_success} bx bxs-check-circle ${ emailValidated ? '' : style.hidden}`}></i>
        <i onClick={emptyEmailInput} className={`${style.icon} ${style.icon_error} bx bxs-x-circle ${!emailValidated ? '' : style.hidden}`}></i>
        </div>
        <div className={`${style.input_container}`}>
          ...
          <input
            ...
            ref={pwRef}
            />
        <i className={`${style.icon} ${style.icon_success} bx bxs-check-circle ${ pwValidated ? '' : style.hidden}`}></i>
        <i onClick={emptyPwInput} className={`${style.icon} ${style.icon_error} bx bxs-x-circle ${!pwValidated ? '' : style.hidden}`}></i>
        </div>
        <div className={`${style.input_container}`}>
          ...
          <input
            ...
            />
        <i className={`${style.icon} ${style.icon_success} bx bxs-check-circle ${ nameValidated ? '' : style.hidden}`}></i>
        <i onClick={emptyNameInput} className={`${style.icon} ${style.icon_error} bx bxs-x-circle ${!nameValidated ? '' : style.hidden}`}></i>
        </div>
        <div className={`${style.input_container}`}>
