...
export default function Card({ id, userId, storeId, review, thumb_nail_image }) {
  ...
  return (
    <div className={`${style.container}`}>
      <Profile name={user.name} url={user.img_url} review_count={user.review_count} />
      <img src={thumb_nail_image} alt="리뷰그림" className={`${style.img_container}`} />
